...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__sgd

#else
#  define SWIG_init    init_sgd

#endif
#define SWIG_name    "_sgd"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_sgd(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!SWIG_Python_UnpackTuple(args, "sgd", 3, 3, swig_obj)) SWIG_fail;
  {
  ...
  if (!SWIG_IsOK(ecode4)) {
    SWIG_exception_fail(SWIG_ArgError(ecode4), "in method '" "sgd" "', argument " "4"" of type '" "int""'");
  } 
  arg4 = static_cast< int >(val4);
  ecode5 = SWIG_AsVal_double(swig_obj[2], &val5);
  if (!SWIG_IsOK(ecode5)) {
    SWIG_exception_fail(SWIG_ArgError(ecode5), "in method '" "sgd" "', argument " "5"" of type '" "double""'");
  } 
  arg5 = static_cast< double >(val5);
  np_sgd(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { "sgd", _wrap_sgd, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
